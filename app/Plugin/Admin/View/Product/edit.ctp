                    ...
                    <div class="slate">
                        ...
                        <div id="template-image-uploader" style="padding:0px;margin:0px;">
                            ...
                            <div id="box-template-image" class="row-fluid">
                                ...
                                <div class="span8"><a class="featured-thumbnail"><img src="<?php echo $this->webroot . "uploads/{$data['type']}/" . $data['image']; ?>" style="width:60px"></a></div>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                            ...
                            <div id="box-featured-image" class="row-fluid">
                                ...
                                <div class="thumbnail" style="width:24%;float:left;margin-left:5px;margin-bottom:10px;">
                                    <a class="featured-thumbnail">
                                        <img src="<?php echo $this->webroot . "uploads/{$data['type']}/" . $image; ?>" style=""></a>
                                    <div class="caption">
