...
<table class="orders-table table">
    <tbody>
        ...
        <tr>
            <td><a href="<?php echo $base; ?>view/?id=<?php echo $value['Order']['guid']; ?>">#<?php echo $value['Order']['guid']; ?> - Joe Bloggs</a> <span class="label label-info"><?php echo $value['Order']['status']; ?></span></td>
