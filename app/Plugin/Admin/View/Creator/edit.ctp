                ...
                <div class="span8">
                    <div class="slate">
                        ...
                        <fieldset>
                            ...
                            <div class='well'>
                                <h4>Please use ftp to replace template images with same name, all template images in app/webroot/img/template folders.</h4>
                            </div>
                        </fieldset>
                    </div>
                </div>
                    ...
                    <?php if ($data['type'] == 'template') : ?>
                        <div class="slate">
                            ...
                            <div>
                                ...
                                <p>
                                    <img src="<?php echo $data['image']['background']; ?>" />
                                    <input type="text" class="input-xlarge" value="<?php echo $data['image']['background']; ?>" />
                                </p>
                                <h4>Overlay Image</h4>
                                <p>
                                    <img src="<?php echo $data['image']['foreground']; ?>" style="background-color:#ccc;" />
                                    <input type="text" class="input-xlarge" value="<?php echo $data['image']['foreground']; ?>" />
                                </p>
                            </div>
                        </div>
                    <?php else: ?>
                                        ...
                                        <?php foreach ($images as $key => $image) : ?>
                                            <div class="thumbnail" style="width:20%;float:left;margin-left:5px;margin-bottom:10px;">
                                                <a class="featured-thumbnail">
                                                    <img src="<?php echo $this->webroot . "uploads/creator/" . $data['featured2']['150w'][$key]; ?>" style=""></a>
                                                <div class="caption">
...
<script type='text/javascript'>
    ...
    function save(action) {
        ...
        jQuery.ajax({
            url: "<?php echo $base; ?>creator/edit/?action=" + action,
