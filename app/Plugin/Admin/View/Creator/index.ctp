<?php
$product_add = $base . "creator" . DS . "add";
$product_edit = $base . "creator" . DS . "edit";
$product_delete = $base . "creator" . DS . "delete";
?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="span12 listing-buttons">
                <a href="<?php echo $this->webroot; ?>admin/creator/add" class="btn btn-primary">New Template</a>
            </div>
            <div class="span12">
                <div class="slate">
...
<?php echo $this->element("action_del", array ("plugin"=>"Admin", "actionUrl" => $base . "creator/delete/", "form" => "#form-filter", "message" => "Are you sure to remove this product?")); ?>