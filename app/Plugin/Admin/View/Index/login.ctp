                    ...
                    <form class="form-horizontal" id="user-form" >
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <a tabindex="-1" href="javascript:void(0);" onclick="javascript:document.images.captcha.src = '<?php echo $this->webroot . 'admin/index/captcha'; ?>?' + Math.round(Math.random(0) * 1000) + 1">Reload image</a>
                                <br/>
