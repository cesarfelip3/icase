<?php
/*
 * There are different folders in webroot/uploads for uploaded files, 
 * the reason is simple, many files uploaded are stored in server temperorily,
 * all these files should be removed periodly.
 * 
 * Should we store all upload files info in db? I don't think so, to clean these 
 * files, we don't have to make them into db.
 */
