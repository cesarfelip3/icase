                    ...
                    <div class="span3">
                        <div class="thumbnail">
                            <a href="<?php echo $this->webroot . "product/" . $value['Product']['slug']; ?>">
                                <img src="<?php echo $this->webroot . "uploads/product/" . str_replace (".", "_500.", $value['Product']['featured']['origin'][0]); ?>" alt="<?php echo $value['Product']['name']; ?>" style="width:100%;height:150px;">
                            </a>
                            <div class="caption">
