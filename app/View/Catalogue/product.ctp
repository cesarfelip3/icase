...
<div class="body-text">
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span6">
                <div style="background-color:white;border-radius: 5px;border:1px solid #ccc;padding:10px;"><img src="<?php echo $data['image']; ?>" alt="<?php echo $data['name'] . ", custom mobile phone case"; ?>"></div>
            </div>
            <div class="span6">
                ...
                <div class="thumwrapper">
                    <?php if (!empty($data['featured'])) : ?>
                        <?php foreach ($data['featured'] as $image) : ?>
                            <img src="<?php echo $image; ?>" style="width:50px;height:auto;" alt="<?php echo $data['name'] . ", custom mobile phone case"; ?>">
                        <?php endforeach; ?>
                    <?php endif; ?>
                </div>
            </div>			
