...
//            var level = $(this).data('level');
            ...
            var json = $("input[name='industry']").val ();
            var object = null;
            ...
            console.log (json);
            $("input[name='industry']").val (json)
            
            $("#box-filter-industry-select h4").append ('<div style="display:inline">&nbsp;<span class="label label-important">' + name + '</span>&nbsp;<a href="javascript:" style="text-decoration: none;" class="btn-filter-industry-remove" data-guid="' + guid + '"><i class="icon-remove-circle"></i></a>&nbsp;&nbsp;</div>');
            init2 ();
    ...
    function init2 ()
    {
        $(".btn-filter-industry-remove").click (
            function () {
                $(this).parent().remove ();
