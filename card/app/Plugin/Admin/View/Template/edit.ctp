                    ...
                    <div class="slate">
                        ...
                        <fieldset>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input class="input-xlarge focused" id="focusedInput" type="text" name="template[name]" value="<?php echo $data['name']; ?>" >
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea class="ckeditor" cols="80" id="editor1" name="template[description]" rows="10"><?php echo $data['description']; ?></textarea>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="focusedInput">Width</label>
                                <div class="controls">
                                    <input class="input-small focused" id="focusedInput" type="text" name="template[width]" value="<?php echo $data['width']; ?>" >
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input class="input-small focused" id="focusedInput" type="text" name="template[height]" value="<?php echo $data['height']; ?>" >
                                    <span class="help-inline">mm</span>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="checkbox">
                                        <input type="checkbox" id="optionsCheckbox2" name="template[is_featured]" value="1" <?php if ($data['is_featured'] == 1) echo 'checked="true"'; ?>>
                                        Yes
                                        <span class="help-inline"></span>
                                    </label>
                                </div>
                                ...
                                <div class="controls">
                                    <label>
                                        <select name="template[industry_guid]">
                                            ...
                                            <option value="<?php echo $value['guid']; ?>" <?php if ($value['guid'] == $data['industry_guid']) echo 'selected'; ?>>
                                                <?php echo $value['name']; ?>
                                            </option>
                                            <?php endforeach; ?>
                                            <?php endif; ?>
    ...
    function categorylist () {
        ...
        jQuery.ajax({
            ...
            $("input[type=radio]").each (function (index, element) {
                if ($(element).val() === "<?php echo $data['category_guid']; ?>") {
        ...
        jQuery.ajax({
            ...
            if (result.error == 1) {
                ...
                if (action == 'create') {
                    ...
                    window.location.href="<?php echo $base; ?>creator/create/?action=edit&id=" + result.data;
                }
