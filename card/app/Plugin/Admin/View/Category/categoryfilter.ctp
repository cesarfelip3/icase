...
if (!empty($data)) :
    foreach ($data as $value) :
        ...
        <?php if (isset($checkbox) && $checkbox) : ?><input type="radio" name="category[]" value="<?php echo $value['Category']['guid']; ?>" <?php if (isset($value['Category']['selected']) && $value['Category']['selected']) echo 'checked="checked"'; ?> /><?php endif; ?> 
